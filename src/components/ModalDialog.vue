<script setup>
/**
 * Markazda ochiladigan modal — Uyimiz Agent panelidagi ModalDialog bilan
 * bir xil. Eski `Modal.vue` dan farqi: Escape bilan yopiladi, orqa fon
 * qulflanadi va telefonda pastdan chiqadigan varaqqa aylanadi.
 */
